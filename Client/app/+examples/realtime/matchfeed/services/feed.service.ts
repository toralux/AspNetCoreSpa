...
export class FeedService {
    ...
    public updateMatch: Observable<Match>;
    public addFeed: Observable<Feed>;
    public addChatMessage: Observable<ChatMessage>;
    ...
    public start(debug: boolean): Observable<SignalRConnectionStatus> {
