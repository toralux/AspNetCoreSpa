...
namespace Server.Chat.Controllers
{
    ...
    public class MatchesController : ApiHubController<Broadcaster>
    {
        ...
        public MatchesController(IConnectionManager signalRConnectionManager, IMatchRepository matchRepository) : base(signalRConnectionManager)
        {
